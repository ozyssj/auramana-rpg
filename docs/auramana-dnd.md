...
<section class="raca">
  ...
  <ul>
    ...
    <li><strong>Sono Diurno:</strong> Enquanto estiver de dia, você precisa passar seis horas em vez de quatro no subterrâneo ou num lugar escuro (como num caixão). Você fica inconsciente e indefeso enquanto isso, em estado de torpor. Se fizer isso, recupera PV e PM (ou espaços de magia) por descanso. Caso contrário, sofre os efeitos de exaustão, mesmo sendo morto-vivo.</li>
