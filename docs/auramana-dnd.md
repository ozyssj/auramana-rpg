...
<section class="raca">
  ...
  <ul>
    ...
    <li><strong>Ogro/Gigante:</strong> Seu tamanho muda para grande, você recebe +2 em Força, -2 em Destreza e uma quantidade de PV extras iguais a quatro vezes o seu bônus de proficiência.</li>
    <li><strong>Tritão/Undine:</strong> Você recebe deslocamento de natação, em metros, igual a quatro vezes seu bônus de proficiencia e pode respirar de baixo d'água.</li>    
  </ul>
</section>
...
<section class="raca">
  <h3>Múmia e Demais Mortos Vivos</h3>
  <hr>
  <ul>
    <li><strong>Idade:</strong> Não envelhece.</li>
    <li><strong>Tamanho:</strong> Médio.</li>
