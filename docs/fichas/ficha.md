    ...
    <script>
        ...
        function carregarFicha() {
            ...
            reader.onload = function(e) {
                ...
                atualizarPericias(); // recalcula depois de carregar
            };
        ...
        classes.forEach(classePersonagem => {
            selectClasse.innerHTML += `<option>${classePersonagem}</option>`;
        });
