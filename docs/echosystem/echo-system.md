...
<body>
    ...
    <div class="main-content">
        ...
        <div class="example">
            <p><strong>Ex1:</strong> Buccaneer Fayir wants to cross a narrow ramp to reach the roof of another building. This action requires an Acrobatics roll of DIF 80%. He has DEX 20 and Acrobatics 25.</p>
        ...
        <div class="abilities-grid">
            ...
            <div class="ability-card">
                ...
                <div class="ability-description">
                    <p> DIF% of skills used used as defense against attacks and other harmful effects.</p>
                    ...
                    <p><strong>ForDef:</strong> Fortitude Defense, used against brute stress.</p>
                    <p><strong>AthDef:</strong> Athletics Defense, used against brute force.</p>
                    <p><strong>CogDef:</strong> Cognition Defense, used against mental stress.</p>
                </div>
            </div>
            ...
            <div class="ability-card">
                ...
                <div class="ability-description">
                    ...
                    <p><strong>Meelee Attack:</strong> Meelee Attack DIF%: 50 + STRENGH + Fight.</p>
                    <p><strong>Ranged Attack:</strong> Ranged Attack DIF%: 50 + DEXTERITY + Aim.</p>
                    <p><strong>Magical Attack:</strong> Magical Attack DIF%: 50 + Spellcasting Attribute + Spellcasting Skill.</p>
                </div>
            </div>
