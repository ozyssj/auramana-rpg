  ...
  <div class="ficha-container">
    ...
    <div class="atributos">
      ...
      <div class="campo">
        ...
        <input type="number" id="sen" min="-5" max="10">
      </div>
      <div class="campo">
            ...
            <div class="defesa">
                <div class="linha">
                    <div class="campo">
                        ...
                        <input type="number" class="valor-defesa" readonly>
                    </div>
                </div>
            </div>
...
<script>
  const pericias = [
    ...
    { nome: "Conh Alquimia", atributo: "int" },
    { nome: "Conh Arcano", atributo: "int" },
    { nome: "Conh Histórico", atributo: "int" },
    { nome: "Conh Médico", atributo: "int" },
    { nome: "Conh Natureza", atributo: "int" },
    { nome: "Conh Nobreza", atributo: "int" },
    { nome: "Conh Religião", atributo: "int" },
